...
EurekaColorDiscrete[z_]:=Piecewise[
					Table[
						{eurcolors[[i]], i/16 <= z <= (i+1)/16},
						{i,0,15}]
					]

fR[z_]:= 1.6948288689925386` -23.261258708411777` z+287.2526163432904` z^2-1810.4518732444687` z^3+5628.963095381033` z^4-7011.045446857542` z^5-4882.209365117081` z^6+26678.38600331812` z^7-34352.922053205824` z^8+20056.376018983447` z^9-4572.384221792814` z^10
fG[z_]:= 0.8030877975937706` +10.631598957452278` z-210.92580293897421` z^2+2051.2692616728787` z^3-11700.41291714229` z^4+40848.42630045395` z^5-88740.67351597158` z^6+119937.22476103417` z^7-97956.1258709181` z^8+44251.35374756834` z^9-8491.570696847932` z^10
fB[z_]:=Piecewise[{
			{1, 0<=z<=0.33},
...
EurekaColorSmooth[z_]:=If[0<=z<=0.03, 
							White,
							RGBColor[{fR[z],fG[z],fB[z]}]
						]
